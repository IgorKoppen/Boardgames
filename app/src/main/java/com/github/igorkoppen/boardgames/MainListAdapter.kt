...
import com.github.igorkoppen.boardgames.databinding.BoardGameItemBinding
...
class MainListAdapter(
    ...
    override fun onBindViewHolder(holder: GameViewHolder, position: Int) {
        ...
        Glide.with(holder.itemView.context).load(currentBoardGame.url).into(holder.binding.imageUrl)
